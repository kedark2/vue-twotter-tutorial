<template>
    <form class="create-twoot-panel" @submit.prevent="createNewTwoot" :class="{ '--exceeded': newTwootCharacterCount > 50}">
        <label for="newTwoot"><strong>New Twoot</strong>({{ newTwootCharacterCount}}/50)</label>
