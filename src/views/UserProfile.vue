        ...
        <div class="user-profile_side">
            <div class="user-profile_user-panel">
                ...
                <!-- <form action="" class="user-profile_create-twoot" @submit.prevent="createNewTwoot" :class="{'--exceeded': newTwootCharacterCount > 180}">
                    <label for="newTwoot"><strong>New Twoot</strong> ({{ newTwootCharacterCount }})</label>
                    <textarea id="newTwoot" cols="30" rows="4" v-model="newTwootContent"></textarea>
